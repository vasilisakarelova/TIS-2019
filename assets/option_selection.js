...
"undefined" == typeof window.Shopify && (window.Shopify = {}), Shopify.each = function(t, e) {
    ...
    function o(t, e, o, i) {
        if (e = n(e, 2), o = n(o, ","), i = n(i, "."), isNaN(t) || null == t)
            return 0;
    ...
    // }
    for (var r = 0; r < o.product.variants.length; r++) {
        var n = document.createElement("option");
        n.value = o.product.variants[r].title
        n.innerHTML = o.product.variants[r].title
